...
import {Proof, parseProof} from "./_utils/ProofUtils.sol";
...
contract BridgedKeystoreTest is Test {
    function test_isValueHashCurrent_EmptyRecord() public {
        ...
        // TODO: Use forge-lib to get the chain id.
        ...
        // Get the storage proof for the Keystore on the L2.
        // cast proof 0x610A7e97C6D2F1E09e6390F013BFCc39B8EE49e2
        // 0xada5013122d395ba3c54772283fb069b10426056ef8ca54750cb9bb552a59e7d --rpc-url https://sepolia.base.org --block
        // 16802894 > test/_res/keystore_storage_proof.base-sepolia.16802894.json
        Proof memory keystoreProof = parseProof("./test/_res/keystore_storage_proof.base-sepolia.16802894.json");
    ...
    function test_syncKeystoreStorageRoot() public {
        ...
        OPStackProofData memory l1BlockProofData;
        {
            ...
            // 16954442 > test/_res/l1Block_storage_proof.base-sepolia.16954442.json
            Proof memory l1BlockProof = parseProof("./test/_res/l1Block_storage_proof.base-sepolia.16954442.json");
        ...
        KeystoreStorageRootProof memory keystoreStorageRootProof;
        {
            ...
            // https://eth-sepolia.public.blastapi.io --block 6928356 >
            // test/_res/anchorStateRegistry_storage_proof.eth-sepolia.6928356.json
            Proof memory anchorStateRegistryProof =
                parseProof("./test/_res/anchorStateRegistry_storage_proof.eth-sepolia.6928356.json");
            ...
            // --block 16802894 > test/_res/keystore_storage_proof.base-sepolia.16802894.json
            Proof memory keystoreProof = parseProof("./test/_res/keystore_storage_proof.base-sepolia.16802894.json");
