...
contract BridgedKeystoreTest is Test {
    function test_syncKeystoreRoot_ForkBaseSepolia() public {
    ...
    function test_isValueCurrent_ForkBaseSepolia() public {
        ...
        assertTrue(sut.isValueCurrent(keyspaceID, keyspaceID, proof));
    }
}
