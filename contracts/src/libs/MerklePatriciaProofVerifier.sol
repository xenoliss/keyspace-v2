...
/**
 * MerklePatriciaProofVerifier Fork Ancestry
            ...
            if (node.length == 2) {
                ...
                if (isLeaf) {
                    ...
                    if (i < stack.length - 1) {
                        ...
                        revert("leaf node not last in proof");
                    }
                ...
                if (mptKeyOffset != mptKey.length) {
                    ...
                    if (_isEmptyBytesequence(node[nibble])) {
                        ...
                        if (i != stack.length - 1) {
                            ...
                            revert("empty node not last in proof");
                        }
                    ...
                    if (i != stack.length - 1) {
                        ...
                        revert("branch node not last in proof");
                    }
